...
const Footer = () => {
  ...
  const verificaTemaDark = theme === "dark" || false

  return (
    <footer>
      <div className={ theme === 'light'? styles.footerWrapper : styles.footerWrapperDark }>
          ...
          <div className="container">
            <div className={`row`}>
              <div className="col-sm-12 col-lg-6">
                ...
                <img className={`${verificaTemaDark? styles.iconsDark : ''} ${styles.dhLogo}`} src="/images/DH.png" alt='DH-logo' />
              </div>
              <div className={`col-sm-12 col-lg-6 ${verificaTemaDark ? styles.iconsDark : ''} ${styles.icons}`}>
